...
yellow:="|<>0xFDB300@0.90$6.zzzzzU"
,green:="|<GREEN>0xDF5A3D@0.96$16.zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzU"
,rope:="|<rope>0xE2CD5A@0.96$3.GGGGGGGGGGGGI"
;param

 if (ok:=FindText(0, 0, 1920, 1080, 0, 0,%param%))
 {
   ;OutputDebug %X%,%Y%
   X:=ok.1.x, Y:=ok.1.y
   Clipboard = %X%,%Y%
